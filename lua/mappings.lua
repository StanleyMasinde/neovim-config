...
vim.api.nvim_set_keymap("n", "<leader>gd", "<cmd>Gdiffsplit<CR>", { noremap = true, silent = true, desc = "Git diff split" })

-- Project and session management
vim.api.nvim_set_keymap("n", "<leader>fp", "<cmd>Telescope projects<CR>", { noremap = true, silent = true, desc = "Find projects" })
vim.api.nvim_set_keymap("n", "<leader>qs", "<cmd>lua require('persistence').load()<CR>", { noremap = true, silent = true, desc = "Restore session" })
vim.api.nvim_set_keymap("n", "<leader>ql", "<cmd>lua require('persistence').load({ last = true })<CR>", { noremap = true, silent = true, desc = "Restore last session" })
vim.api.nvim_set_keymap("n", "<leader>qd", "<cmd>lua require('persistence').stop()<CR>", { noremap = true, silent = true, desc = "Stop session recording" })

-- Harpoon mappings
vim.api.nvim_set_keymap("n", "<leader>ha", "<cmd>lua require('harpoon'):list():add()<CR>", { noremap = true, silent = true, desc = "Harpoon add file" })
vim.api.nvim_set_keymap("n", "<leader>hm", "<cmd>lua require('harpoon').ui:toggle_quick_menu(require('harpoon'):list())<CR>", { noremap = true, silent = true, desc = "Harpoon menu" })
vim.api.nvim_set_keymap("n", "<leader>1", "<cmd>lua require('harpoon'):list():select(1)<CR>", { noremap = true, silent = true, desc = "Harpoon file 1" })
vim.api.nvim_set_keymap("n", "<leader>2", "<cmd>lua require('harpoon'):list():select(2)<CR>", { noremap = true, silent = true, desc = "Harpoon file 2" })
vim.api.nvim_set_keymap("n", "<leader>3", "<cmd>lua require('harpoon'):list():select(3)<CR>", { noremap = true, silent = true, desc = "Harpoon file 3" })
vim.api.nvim_set_keymap("n", "<leader>4", "<cmd>lua require('harpoon'):list():select(4)<CR>", { noremap = true, silent = true, desc = "Harpoon file 4" })
...
vim.api.nvim_set_keymap("n", "<leader>ca", "<cmd>CodeActionMenu<CR>", { noremap = true, silent = true, desc = "Code Action Menu" })

-- Refactoring
vim.api.nvim_set_keymap("v", "<leader>re", "<cmd>lua require('refactoring').refactor('Extract Function')<CR>", { noremap = true, silent = true, desc = "Extract Function" })
vim.api.nvim_set_keymap("v", "<leader>rf", "<cmd>lua require('refactoring').refactor('Extract Function To File')<CR>", { noremap = true, silent = true, desc = "Extract Function To File" })
vim.api.nvim_set_keymap("v", "<leader>rv", "<cmd>lua require('refactoring').refactor('Extract Variable')<CR>", { noremap = true, silent = true, desc = "Extract Variable" })
vim.api.nvim_set_keymap("v", "<leader>ri", "<cmd>lua require('refactoring').refactor('Inline Variable')<CR>", { noremap = true, silent = true, desc = "Inline Variable" })
